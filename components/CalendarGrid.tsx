          ...
          weekDays.map((d, i) => {
            ...
            return (
              <DayCell
                ...
                sortByLastName={sortByEventUserLastName}
              />
            );
          })
        )}
      ...
      <div className="grid grid-rows-2 h-full flex-1 space-y-0.5 overflow-y-auto">
        <div className="border-b border-dashed border-black-900">
          {events.filter((e: CalendarEvent) => {
            ...
            return (dateStr > start && dateStr < end) || (dateStr === start && e.startPeriod === 'morning') || (dateStr === end && e.endPeriod === 'morning') || (dateStr > start && dateStr === end && e.endPeriod === 'afternoon')
          })
            .sort(sortByLastName)
            .map((e: CalendarEvent) => (
              <div
